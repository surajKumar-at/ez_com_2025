...
serve(async (req: Request) => {
  console.log("Edge function get-sap-invoice-partners called");
  ...
  try {
    ...
    console.log(`Processing request for SAP Invoice partners, Invoice ID: ${invoiceId}`);
    ...
    try {
      ...
      // Construct the API path for the invoice partner
      const apiPath = `/sap/opu/odata/sap/API_BILLING_DOCUMENT_SRV/A_BillingDocument('${encodeURIComponent(invoiceId)}')/to_Partner`;
