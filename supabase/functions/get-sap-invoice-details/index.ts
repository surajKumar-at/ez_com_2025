...
serve(async (req: Request) => {
  console.log("Edge function get-sap-invoice-details called");
  ...
  try {
    ...
    console.log(`Processing request for SAP Invoice ID: ${invoiceId}`);
    ...
    try {
      ...
      // Construct the API path for the specific invoice
      const apiPath = `/sap/opu/odata/sap/API_BILLING_DOCUMENT_SRV/A_BillingDocument('${encodeURIComponent(invoiceId)}')`;
      ...
      console.log("Parsed cookies:", cookies.length > 0 ? "Yes" : "No");
